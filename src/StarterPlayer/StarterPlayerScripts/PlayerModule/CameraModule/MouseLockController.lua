...
function MouseLockController.new()
	...
	self.boundKeys = {Enum.KeyCode.LeftControl, Enum.KeyCode.RightShift, Enum.KeyCode.ButtonL3} -- defaults
	...
	if (not boundKeysObj) or (not boundKeysObj:IsA("StringValue")) then
		...
		boundKeysObj.Value = "LeftControl,RightShift,ButtonL3"
...
function MouseLockController:UpdateMouseLockAvailability()
	...
	local MouseLockAvailable

	if isConsole then
		-- Always allow on console if dev allows it
		MouseLockAvailable = devAllowsMouseLock and not devMovementModeIsScriptable
	else
		MouseLockAvailable = devAllowsMouseLock and userHasMouseLockModeEnabled and not userHasClickToMoveEnabled and not devMovementModeIsScriptable
	end
